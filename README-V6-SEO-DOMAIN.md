...
- LocalBusiness / BeautySalon, WebSite, WebPage, Service, Breadcrumb ve FAQ JSON-LD yapılandırılmış verileri eklendi.
- `admin-yorumlar.html` noindex/nofollow kaldı.
- `yorum-birak.html` noindex/follow yapıldı ve sitemap dışına alındı.
- JS'in tüm sayfalarda ana sayfa başlığını ezmesi engellendi.
- `manifest.webmanifest` eklendi.
- Netlify/Cloudflare Pages için opsiyonel `_headers` dosyası eklendi. GitHub Pages bu dosyayı header olarak uygulamaz.
...
## Not
Domain müsaitliği bu paketle garanti edilmez. Satın alma ekranından kontrol edilmelidir.
